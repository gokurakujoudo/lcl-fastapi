...
- Default branch: main; persistent publication branch: release; feature prefix: codex/. Version 0.2.0 preparation was merged in PR #18. Current issue #19 delivers three separately implemented and verified features in one PR; no new publication is requested. Preserve main and release and do not replace published version artifacts.
