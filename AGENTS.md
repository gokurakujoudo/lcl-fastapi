...
- Default branch: main; persistent publication branch: release; feature prefix: codex/. The user has authorized reviewing and squash-merging the implementation PR, then publishing the 0.1.1 release through CI to PyPI and GitHub. Keep main and release; clean up the completed feature branch only after verified publication.
