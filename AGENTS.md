...
- Agents share a workspace. Respect assigned file ownership and coordinate shared files before editing. All implementation and verification work is delegated to subagents; the root agent supervises and communicates progress.
